...
const Mission = () => {
  return (
    <div className="mx-8 xl:mx-56 my-32 grid grid-flow-row gap-y-4 gap-x-16 md:grid-flow-col">
      <img src={rocket} className="mx-auto  md:h-72" alt="Fusée" />
      <div className="grid grid-flow-row gap-2">
        <h3 className="text-lg text-gray-dark text-center">
          VOTRE RÊVE. NOTRE MISSION.
        </h3>
        <h2 className="text-2xl font-extrabold text-secondary text-center md:text-3xl lg:text-4xl">
