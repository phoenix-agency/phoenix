import AccessibleTechPic from "./../../assets/AccessibleTech.png";
import ChiffreDeux from "./../../assets/ChiffreDeux.png";
import BoutonRond from "./../../assets/svg/BoutonRond";

function accessibleTech() {
    return (
        <div className="Container-Wordpress Title-Row-Reverse">
            <div className="Wordpress-Container-Text">
                <div>
                    <img src={ChiffreDeux} alt='Illustration chiffre deux' className='Chiffre-Wordpress' />
                </div>
            ...
            <div className='IllustrationSection'>
                    <img src={AccessibleTechPic} alt='Illustration société' />
            </div>
        </div>
    );
}

export default accessibleTech;