        ...
        <div className="flex flex-col h-full">
          <div className=" h-full bg-white rounded-3xl px-6 pt-6 pb-14 hover:rounded-none hover:border hover:border-primary transition-all duration-300">
            ...
            <p className="text-gray-light">
              ...
              davantage de prospects qualifiés pour un développement de chiffre
        ...
        <div className="flex flex-col h-full">
          <div className=" h-full bg-white rounded-3xl px-6 pt-6 pb-14 hover:rounded-none hover:border hover:border-primary transition-all duration-300">
            ...
            <p className="text-gray-light">
              ...
              WordPress, création de site internet WordPress, hébergement de
              site internet WordPress, maintenance de site internet WordPress.
            </p>
          </div>
          <div className="mt-auto">
            <Button2
